...
namespace dev {
    ...
    MyPipeline::~MyPipeline() {
        vkDestroyShaderModule(MyEngineDevice.device(), vertShaderModule, nullptr);
        vkDestroyShaderModule(MyEngineDevice.device(), fragShaderModule, nullptr);
        vkDestroyPipeline(MyEngineDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    void MyPipeline::createGraphicsPipeline(const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo)
    {
        assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "cannot create pipeline: no layout provided");
