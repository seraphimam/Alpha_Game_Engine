...
namespace dev {
    ...
    MyEngineSwapChain::MyEngineSwapChain(MyDevice& deviceRef, VkExtent2D extent)
        : device{ deviceRef }, windowExtent{ extent } {
        init();
    }

    MyEngineSwapChain::MyEngineSwapChain(MyDevice& deviceRef, VkExtent2D extent, std::shared_ptr<MyEngineSwapChain> previous)
